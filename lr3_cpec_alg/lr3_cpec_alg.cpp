...
// lr3_cpec_alg.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clr3cpecalgApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &Clr3cpecalgApp::OnAppAbout)
...
// Создание Clr3cpecalgApp

Clr3cpecalgApp::Clr3cpecalgApp() noexcept
{
	...
	SetAppID(_T("lr3cpecalg.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Clr3cpecalgApp

Clr3cpecalgApp theApp;


// Инициализация Clr3cpecalgApp

BOOL Clr3cpecalgApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(Clr3cpecalgDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(Clr3cpecalgView));
	if (!pDocTemplate)
		return FALSE;
...
int Clr3cpecalgApp::ExitInstance()
{
...
// Обработчики сообщений Clr3cpecalgApp
...
void Clr3cpecalgApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
